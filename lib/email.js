    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api OMR28 - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=628565251134">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"ohmyriiss28" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api OMR28`,
        html: inboxGmail,
      };
